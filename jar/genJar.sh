...
SCRIPT_DIR="/Users/moss/workspace/private/CatVodSpider/jar"
...
# 反编译 dex 文件到 smali
java -jar "$SCRIPT_DIR/3rd/baksmali-2.5.2.jar" d "/Users/moss/workspace/private/CatVodSpider/app/build/intermediates/dex/release/minifyReleaseWithR8/classes.dex" -o "$SCRIPT_DIR/Smali_classes"
